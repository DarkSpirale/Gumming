...
namespace DTerrain
{
    ...
    public class ClickAndDestroyOptimized : ClickAndDestroy
    {
        ...
        protected override void OnLeftMouseButtonClick()
        {
            ...
            { 
                Color = Color.clear, 
                Position = new Vector2Int((int)(p.x * primaryLayer.PPU) - destroyCircleSize, (int)(p.y * primaryLayer.PPU) - destroyCircleSize), 
                Shape = shapeToDestroy, 
            ...
            {
                Color = Color.clear,
                Position = new Vector2Int((int)(p.x * secondaryLayer.PPU) - destroyCircleSize, (int)(p.y * secondaryLayer.PPU) - destroyCircleSize), 
                Shape = shapeToDestroy, 
                PaintingMode=PaintingMode.REPLACE_COLOR,
